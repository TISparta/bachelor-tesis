...
Tercero, se brindan detalles necesarios simular nuestros diseños utilizando el software de modelamiento SPINS-B \citep{Su2020}.
...
Finalmente, se describen seis algoritmos de optimización utilizados en este trabajo.
...
%Al estudiar dispositivos fotónicos es de especial interés la
...
Un \emph{bend} es un dispositivo fotónico que se encarga de guiar el giro de un haz de ondas. Un \emph{bend} convencional consiste en una una guía de onda horizontal usada como entrada y
...
(ii) proyección.
Esta sección está basada en \cite{Lazarov2016}, para una descripción más detallada favor de revisar este trabajo.
...
caso contrario, el diseño podría representar una dilatación o erosión muy exageradas  [CITEXXX].
